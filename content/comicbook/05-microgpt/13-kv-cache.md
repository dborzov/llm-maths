...
- **KV quantization (KIVI, KVQuant, 2023–2024).** Compress the cache to 4-bit or 2-bit per element. Per-channel scales, channel-grouped quantization to defend against outlier dimensions. See [issue 03's KV-cache deep-dive](../../03-quantization/) for why the K and V tensors have very different statistical profiles and need different quantization schemes.
