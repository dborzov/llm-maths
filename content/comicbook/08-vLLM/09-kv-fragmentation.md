...
**Per sequence.** That is more memory than four H100s. (See [Issue 06](/llm-maths/comicbook/06-kvcache-pruning/02-kv-crisis/) for the full napkin math — it's the entire reason that issue exists.) At this scale, a 1% allocator waste is 3 GB. A 60% allocator waste is a second-mortgage GPU.
