...
This chapter unpacks that claim from the inside. Not the "what" — the [Issue 5 chapter](/comicbook/05-microgpt/19-mla/) has the what. The "why it was the right opening move, and what it left unfinished."
...
- **[Issue 5, ch.19 — MLA](/comicbook/05-microgpt/19-mla/)**: The full microGPT implementation walk-through with code. This chapter gave you the strategic frame; that one gives you the code.
- **[Issue 5, ch.13 — KV Cache](/comicbook/05-microgpt/13-kv-cache/)**: Why the KV cache exists and how standard MHA populates it. Start here if the (2, L, H, T, D) shape was unfamiliar.
- **[Issue 5, ch.8 — Attention](/comicbook/05-microgpt/08-attention/)**: The base attention mechanism. MLA modifies the K/V projection; everything else is standard attention.
