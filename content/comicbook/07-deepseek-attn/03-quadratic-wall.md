...
- **[Issue 5, ch.8 — Attention](/comicbook/05-microgpt/08-attention/)**: The mechanics of standard attention. Everything in this chapter assumes you understand the baseline.
- **[Issue 5, ch.13 — KV Cache](/comicbook/05-microgpt/13-kv-cache/)**: Why the cache exists and how it grows. The problem MLA solved.
