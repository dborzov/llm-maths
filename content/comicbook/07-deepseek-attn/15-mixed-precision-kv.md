...
- [Numbers In Boxes](/comicbook/03-quantization/02-numbers-in-boxes/) — how FP8 and BF16 represent values differently and what that means for rounding behavior
- [Hardware Horizon](/comicbook/03-quantization/12-hardware-horizon/) — Blackwell's native FP4 support, which is what makes the indexer's FP4 path practical at scale
