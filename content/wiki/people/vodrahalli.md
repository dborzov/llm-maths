...
Authors of the **Michelangelo** long-context evaluation framework (2024), which introduced the LSQ (Latent Structure Queries) taxonomy for what a good long-context benchmark should require. Also authors of **OOLONG** (aggregation benchmark, November 2025).
