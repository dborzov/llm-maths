...
Every time someone says "transformers scale to long context," they are quietly ignoring a monster. The monster lives in [Issue 5 ch.8 attention](/issues/05-microgpt-unfolded/08-attention/), specifically in the two lines of code that dominate the entire model's compute at long context:
...
The full microGPT {{< wiki "attention" >}}attention{{< /wiki >}} function from [Issue 5 ch.8](/issues/05-microgpt-unfolded/08-attention/):
